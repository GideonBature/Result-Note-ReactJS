...
const HowItWorks = () => {
    return (
        <div id='howitworks' className="flex flex-col justify-center items-center bg-primaryColor h-screen">
            <div className="mb-10">
                <h2 className="text-3xl font-bold text-center mt-10 font-kumbh text-white">How it works</h2>
                <p className='text-center font-karla text-white pt-5'>Watch the video below to see how <span className='text-bold'>Result Note</span> works!</p>
            </div>
            <div>
