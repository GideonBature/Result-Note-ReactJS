    ...
    return (
        <div className="flex flex-col pt-0 p-8 mr-12 items-center justify-center overflow-hidden">
            ...
            <div className="flex mr-auto">
                <img className="border-2 border-white rounded-full h-8 w-8 -mr-3" src="https://randomuser.me/api/portraits/men/32.jpg" alt="" />
                <img className="border-2 border-white rounded-full h-8 w-8 -mr-3" src="https://randomuser.me/api/portraits/women/31.jpg" alt="" />
                <img className="border-2 border-white rounded-full h-8 w-8 -mr-3" src="https://randomuser.me/api/portraits/men/33.jpg" alt="" />
                <img className="border-2 border-white rounded-full h-8 w-8 -mr-3" src="https://randomuser.me/api/portraits/women/32.jpg" alt="" />
                <img className="border-2 border-white rounded-full h-8 w-8 -mr-3" src="https://randomuser.me/api/portraits/men/44.jpg" alt="" />
                <span className="flex items-center justify-center bg-white text-xs text-secondaryColor font-semibold border-2 border-gray-200 rounded-full h-8 w-8">+26</span>
            </div>
        </div>
    );
}
