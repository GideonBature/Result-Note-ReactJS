...
const navLinks = [
    ...
    { icon: 'bx bx-group', text: 'Students/Classes', path: '/Students' },
            ...
            <div className={`${sidebarWidth} p-5 h-screen duration-700 bg-primaryColor relative `}>
                ...
                <div className='flex-1 mt-5 space-y-2'>
                    ...
                    {navLinks.map((navMenuLink, index) => (
                        <li key={index} className={`group flex items-center hover:bg-secondaryColor rounded-xl p-2 duration-700 ${!open ? 'hover:bg-secondaryColor pl-4 -ml-3 -mr-2.5 rounded-xl' : 'hover:bg-secondaryColor pl-4 -ml-3 -mr-2.5 rounded-xl'}`} >
